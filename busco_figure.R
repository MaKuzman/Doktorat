...
my_species <- c('Amphimedon', 'Amphimedon', 'Amphimedon', 'Amphimedon', 'Ephydatia', 'Ephydatia', 'Ephydatia', 'Ephydatia', 'Eunapius', 'Eunapius', 'Eunapius', 'Eunapius', 'Oscarella', 'Oscarella', 'Oscarella', 'Oscarella', 'Suberites', 'Suberites', 'Suberites', 'Suberites', 'Sycon', 'Sycon', 'Sycon', 'Sycon', 'Tethya', 'Tethya', 'Tethya', 'Tethya')
my_species <- factor(my_species)
my_species <- factor(my_species,levels(my_species)[c(4,2,6,3,7,1,5)]) # reorder your species here just by changing the values in the vector :
my_percentage <- c(79.9, 4.4, 3.5, 12.2, 48.8, 4.5, 23.3, 23.4, 68.9, 9.9, 6.9, 14.3, 65.0, 0.5, 9.0, 25.5, 47.4, 40.7, 2.6, 9.3, 69.5, 5.9, 6.2, 18.4, 80.2, 2.5, 3.3, 14.0)
my_values <- c(781, 43, 34, 120, 477, 44, 228, 229, 674, 97, 67, 140, 636, 5, 88, 249, 464, 398, 25, 91, 680, 58, 61, 179, 784, 24, 32, 138)
